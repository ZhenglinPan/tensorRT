...
void back(int Speed)
{
    pwm.setPWM(0, 1, Speed);
    pwm.setPWM(1, 1, 0);
    pwm.setPWM(12, 1, 0);
    pwm.setPWM(13, 1, Speed);
    pwm.setPWM(15, 1, Speed);
    pwm.setPWM(14, 1, 0);

    pwm.setPWM(3, 1, Speed);
    pwm.setPWM(2, 1, 0);
    pwm.setPWM(11, 1, 0);
    pwm.setPWM(10, 1, Speed);
    pwm.setPWM(8, 1, Speed);
    pwm.setPWM(9, 1, 0);
    
//    交换两个通道，不修改第二个参数的值也可以实现负PWM
//    pwm.setPWM(8, 0, 0);
